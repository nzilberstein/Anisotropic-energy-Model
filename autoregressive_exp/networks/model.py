...
class ModelInput:
    ...
    def __init__(self, noisy: torch.Tensor, noise_level: NoiseLevel = None, covariance: List[Covariance] = None) -> None:
        ...
        if len(t.shape) == 2:
            if self.anisotropic_network is True:
                ...
                if compute_scores:
                    ...
                    denoised = x.noisy - x.noise_covariance.apply(data_score) * t[..., None, None, None]  # (B..., D...)
                else:
            ...
            if self.anisotropic_network is True:
                ...
                if compute_scores:
                    ...
                    denoised = x.noisy - apply_power_to_list_covariances(x.noise_covariance, data_score, p=1)  # (B..., D...)
                    # denoised = x.noisy - data_score * t[..., None, None, None]
                else:
                    energy = self.network_forward(*input_tensors)
                    data_score = None
                    noise_score = None
